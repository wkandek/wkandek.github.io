...
China: China does not have EUV yet, maybe in the labs so their chips are 7nm technology rather than TSMC 2nm. This is a big disadvantages for Chinese chips that will lag behind. China is working on EUV, but it is a difficult technology with high precision optics (from Carl Zeiss) and lares, etc that took ASML 10 years to get from the lab to production. The process has to be largely flawless, if not the wafer is useless... China has EUV in the lab, maybe or even  ikely. Remains to be seen when they will get into production. 
